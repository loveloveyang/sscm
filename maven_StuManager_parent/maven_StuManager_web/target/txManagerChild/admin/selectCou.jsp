                ...
                <table>
                    ...
                    <c:forEach items="${data}" var="cou">
                        <tr>
                            ...
                            <td>
                                <input class="btn" type="button" value="修改课程" onClick="window.location.href=('updateCouPageAdmin?cno=${cou.cno}')">
                            </td>
                            <td>
                                <form action="deleteCouPageAdmin?cno=${cou.cno}" method="post">
