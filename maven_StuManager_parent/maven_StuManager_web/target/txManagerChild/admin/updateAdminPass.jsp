                ...
                <div class="form_1">
                    <form action="updateAdminPass" method="post">
                        <table>
                            ...
                            <tr>
                                <td>工号</td>
                                <td><input class="text" type="text" name="tno" value="${admin.ano}"
                                           readonly="true"/></td>
                            </tr>
                            <tr>
                                <td>旧密码</td>
                                <td><input class="text" type="text" name="apassword" />
                                </td>
                            </tr>
                            <tr>
                                <td>新密码</td>
                                <td><input class="text" type="text" name="newApassword"/></td>
                            </tr>
                            <tr>
                                <td>确认密码</td>
                                <td><input class="text" type="text" name="ConfApassword"/></td>
                            </tr>
                        </table>
