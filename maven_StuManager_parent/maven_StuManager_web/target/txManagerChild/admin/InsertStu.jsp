...
<div class="content">
    ...
    <div class="content-right-contain">
        <div class="box">
            ...
            <div class="form">
                <div class="form_1">
                    <form action="insertStuAdmin" method="post">
                        <table>
                            <tr><td></td></tr>
                            <tr><td>学生姓名</td> <td><input  class="text" type="text" name="sname"/></td>
                            </tr>
                            <tr><td>学生密码</td> <td><input  class="text" type="text" name="spassword"/></td>
                            </tr>
                            <tr><td>学生班级</td> <td><input  class="text" type="text" name="sclass"/></td>
                            </tr>
                            <tr><td>学生性别</td> <td><input  class="text" type="text" name="ssex"/></td>
                            </tr>
