            ...
            <div class="form">
                <table>
                    ...
                    <c:if test="${not empty queryResults}">
                        <c:forEach items="${queryResults}" var="tea">
                            <tr>
                                <td>${tea.tno}</td>
                                <td>${tea.tname}</td>
                                <td>${tea.tpassword}</td>
                                <td>${tea.tsex}</td>
                                <td>${tea.ttelephone}</td>
                                <td>${tea.tcollege}</td>
                                <td>${tea.temail}</td>
                                <td>
                                    <input class="btn" type="button" value="修改课程" onClick="window.location.href=('updateTeaPage?tno=${tea.tno}')">
                                </td>
                                <td>
                                    <form action="deleteTea?tno=${tea.tno}" method="post">
