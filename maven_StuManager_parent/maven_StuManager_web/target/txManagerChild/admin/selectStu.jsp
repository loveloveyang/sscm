    ...
    <div class="content-right-contain">
        <div class="box">
            ...
            <div class="function-right">
                <form action="studentQueryAdmin" method="post">
                    ...
                    <c:forEach items="${students}" var="students">
                        <tr>
                            ...
                            <td><input class="btn" type="button" value="修改信息"
                                       onclick="window.location.href=('updateStuPageAdmin?sno=${students.sno}')">
                            </td>
                            <td>
                                <form action="deleteStuAdmin?sno=${students.sno}" method="post"><input
