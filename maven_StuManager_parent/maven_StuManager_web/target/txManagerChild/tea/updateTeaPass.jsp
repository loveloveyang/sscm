...
<div class="content">
    ...
    <div class="content-right-contain">
        <div class="box">
            ...
            <div class="form">
                <div class="form_1">
                    <form action="updateTeaPass" method="post">
                        <table>
                            <tr>
                                <td></td>
                            </tr>
                            <tr>
                                <td>工号</td>
                                <td><input class="text" type="text" name="tno" value="${teacher.tno}"
                                           readonly="true"/></td>
                            </tr>
                            <tr>
                                <td>旧密码</td>
                                <td><input class="text" type="text" name="tpassword" />
                                </td>
                            </tr>
                            <tr>
                                <td>新密码</td>
                                <td><input class="text" type="text" name="newTpassword"/></td>
                            </tr>
                            <tr>
                                <td>确认密码</td>
                                <td><input class="text" type="text" name="ConfTpassword"/></td>
                            </tr>
                        </table>
