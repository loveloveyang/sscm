            ...
            <div class="form">
                <div class="form_1">
                    <table class="info">
                        <tr>
                            <td></td>
                            <td><input class="text" type="text" value="工号：${tea.tno}" readonly="true"></input></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><input class="text" type="text" value="姓名"：${tea.tname}" readonly="true"></td>
                        </tr>

                        <tr>
                            <td></td>
                            <td><input class="text" type="text" value="性别：${tea.tsex}" readonly="true"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><input class="text" type="text" value="电话：${tea.ttelephone}" readonly="true"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><input class="text" type="text" value="学院：${tea.tcollege}" readonly="true"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><input class="text" type="text" value="邮箱：${tea.temail}" readonly="true"></td>
                        </tr>
