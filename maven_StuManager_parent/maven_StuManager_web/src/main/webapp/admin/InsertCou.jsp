...
<div class="content">
    ...
    <div class="content-right-contain">
        <div class="box">
            ...
            <div class="form">
                <div class="form_1">
                    <form action="insertCouAdmin" method="post">
                        <table>
                            <tr><td></td></tr>
                            <tr><td>课程名称</td> <td><input  class="text" type="text" name="cname"/></td>
                            </tr>
                            <tr><td>课程学分</td> <td><input  class="text" type="text" name="ccredit"/></td>
                            </tr>
                            <tr><td>课程教室</td> <td><input  class="text" type="text" name="cclassroom"/></td>
                            </tr>
