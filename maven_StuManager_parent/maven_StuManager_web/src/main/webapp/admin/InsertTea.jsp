            ...
            <div class="form">
                <div class="form_1">
                    <form action="insertTea" method="post">
                        <table>
                            <tr><td></td></tr>
                            <tr><td>老师姓名</td> <td><input  class="text" type="text" name="tname"/></td>
                            </tr>
                            <tr><td>老师密码</td> <td><input  class="text" type="text" name="tpassword"/></td>
                            </tr>
                            <tr><td>老师性别</td> <td><input  class="text" type="text" name="tsex"/></td>
                            </tr>
                            <tr><td>老师电话</td> <td><input  class="text" type="text" name="ttelephone"/></td>
                            </tr>
                            <tr><td>老师学院</td> <td><input  class="text" type="text" name="tcollege"/></td>
                            </tr>
                            <tr><td>老师邮箱</td> <td><input  class="text" type="text" name="temail"/></td>
                            </tr>
