                ...
                <div class="form_1">
                    <form action="updateTea" method="post">
                        <table>
                            ...
                            <tr>
                                <td>老师编号</td>
                                <td><input class="text" type="text" name="tno" value="${teachers.tno}"
                                           readonly="true"/></td>
                            </tr>
                            <tr>
                                <td>老师姓名</td>
                                <td><input class="text" type="text" name="tname" value="${teachers.tname}"/>
                                </td>
                            </tr>
                            <tr>
                                <td>老师密码</td>
                                <td><input class="text" type="text" name="tpassword" value="${teachers.tpassword}"/>
                                </td>
                            </tr>
                            <tr>
                                <td>老师性别</td>
                                <td><input class="text" type="text" name="tsex" value="${teachers.tsex}"/>
                                </td>
                            <tr>
                                <td>老师电话</td>
                                <td><input class="text" type="text" name="ttelephone" value="${teachers.ttelephone}"/>
                                </td>
                            </tr>
                            <tr>
                                <td>老师学院</td>
                                <td><input class="text" type="text" name="tcollege" value="${teachers.tcollege}"/></td>
                            </tr>
                            <tr>
                                <td>老师邮箱</td>
                                <td><input class="text" type="text" name="temail" value="${teachers.temail}"/></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><input class="btn" type="submit" value="确认修改"/>
                                    <input class="btn" type="reset" value="取消修改"
                                           onClick="window.location.href=('selectTeaPage')"/>
                                </td>
                            </tr>
                        </table>
                    </form>
