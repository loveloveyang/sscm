...
<div class="content">
    ...
    <div class="content-right-contain">
        <div class="box">
            ...
            <div class="form">
                <div class="form_1">
                    <form action="updateCouAdmin" method="post">
                        <table>
                            <tr>
                                <td></td>
                            </tr>
                            <tr>
                                <td>课程编号</td>
                                <td><input class="text" type="text" name="cno" value="${course.cno}" readonly="true"/>
                                </td>
                            </tr>
                            <tr>
                                <td>课程名称</td>
                                <td><input class="text" type="text" name="cname"
                                           value="${course.cname}"/></td>
                            </tr>
                            <tr>
                                <td>课程学分</td>
                                <td><input class="text" type="text" name="ccredit" value="${course.ccredit}"/></td>
                            </tr>
                            <tr>
                                <td>课程教室</td>
                                <td><input class="text" type="text" name="cclassroom"
                                           value="${course.cclassroom}"/></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><input class="btn" type="submit" value="确认修改"/>
                                    <input class="btn" type="button" value="取消修改"
                                           onClick="window.location.href=('selectCouPageAdmin')"></td>
                            </tr>
                        </table>
                    </form>
                </div>
