		...
		<div class="box">
			...
			<div class="form">
				<div class="form_1">
					<table class="info">
						<tr><td></td></tr>
						<tr><td></td><td><input class="text" type="text" value="${student.sname}" readonly="true"></td><td></td><td></td><td></td><td rowspan="2"><img src="/Ten/img/touxiang.png"/></td></tr>
						<tr><td></td><td><input class="text" type="text" value="学号：${student.sno}" readonly="true"></input></td></tr>
						<tr><td></td><td><input class="text" type="text" value="密码：${student.spassword}" readonly="true"></td></tr>
						<tr><td></td><td><input class="text" type="text" value="性别：${student.ssex}" readonly="true"></td></tr>
						<tr><td></td><td><input class="text" type="text" value="班级：${student.sclass}" readonly="true"></td></tr>
						<tr><td></td><td><input class="text" type="text" value="总学分：${stuScre.scredit}" readonly="true"></td>
						</tr>
