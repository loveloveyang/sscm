...
<div class="main">
	...
	<div class="main_right">
		...
		<div class="box">
			...
			<div class="form">
			<div class="form_1">
				<form action="student/InsertStuAction" method="post">
				<table>
  					<tr><td></td></tr>
  					<tr><td>学生姓名</td> <td><input  class="text" type="text" name="student.sname"/></td>
  						<td><span><s:fielderror><s:param>student.sname</s:param></s:fielderror></span></td>
  					</tr>
  					<tr><td>学生密码</td> <td><input  class="text" type="text" name="student.spassword"/></td>
  						<td><span><s:fielderror><s:param>student.spassword</s:param></s:fielderror></span></td>
  					</tr>
  					<tr><td>学生班级</td> <td><input  class="text" type="text" name="student.sclass"/></td>
  						<td><span><s:fielderror><s:param>student.sclass</s:param></s:fielderror></span></td>
  					</tr>
  					<tr><td>学生性别</td> <td><input  class="text" type="text" name="student.ssex"/></td>
