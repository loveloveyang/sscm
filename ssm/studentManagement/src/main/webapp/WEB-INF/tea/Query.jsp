<%@ page language="java" import="java.util.*,com.vo.Teacher,com.user.QueryResult" pageEncoding="utf-8"%>
<%
...
<div class="main">
	<div class="main_left">
		...
		<form action="login/DoLogoutAction" method="post"><input class="reset" type="submit" value="注销"></form>
			    	...
			    	if(session.getAttribute("teacher")==null){
			    		response.sendRedirect("/studentManagerMybatis/Login.jsp");
			    	}else{
	...
	<form action="sc/QueryScAction" method="post" >
 		...
 		<%
  		...
  		<%
				...
				if(ite.hasNext()&&type!=20){//查询结果不为空，输出表格
					...
					<table>
					<tr><td>学号</td><td>学生姓名</td><td>学生班级</td><td>课程号</td><td>课程名</td><td>上课教室</td></tr>
